...
function Form() {
  ...
  const fromhandler = async(e)=>{
    ...
    const responce = await dispatch(loginuserform(data))
...
<div className='flex flex-col justify-start md:justify-center font-sans  md:gap-15 md:flex-row mb-30 '>
  <form  onSubmit={fromhandler} className='border-r border-gray-300 pr-10 ml-5 md:ml-20 mt-10' >
    <div className='flex'>
    <h1 className=' text-3xl border-b border-yellow-400' >Login</h1><div className='w-90 border-b border-gray-300'></div>
    </div>
    <p className='mt-2'>Welcome back! Sign in to your account</p>
    <div className='mt-3 flex-col flex'>
    <label className='font-bold '>Email Address*</label>
    <input id='email' name='email' autoComplete='email' value={email} onChange={emailhandler} type='email' required className='md:w-110 w-full h-12 mt-2 bg-white rounded-4xl border border-gray-300 outline-none pl-5'/>
    </div>
    <div className='mt-3 flex-col flex'>
    <label className='font-bold '>Password*</label>
    <input id='password' name='password' value={password} autoComplete='password' onChange={passwordhandler} type='password' required className='md:w-110 w-full h-12 mt-2 bg-white rounded-4xl border border-gray-300 outline-none pl-5'/>
    </div>
    <div className='flex gap-40 md:gap-47 mt-4  text-gray-800 flex-wrap'>
      <Link to={'/'} className=' hover:text-yellow-300 transition duration-300'>Return to Store</Link>
      <Link to={'#'} className='hover:text-yellow-300 transition duration-300'>Forgotten Password?</Link>
    </div>
    <div className=' mb-10 md:mb-0'>
      <button className=' md:w-30 w-full px-10 py-3 rounded-3xl bg-yellow-400 font-bold hover:bg-black hover:text-white transition duration-300 mt-5'>
        Login
      </button>
    </div>
...
<div className='flex flex-wrap'>
    <h1 className=' flex  text-3xl border-b border-yellow-400' >Create New Account</h1><div className=' w-full md:w-50 border-b border-gray-300'></div>
    </div>
